	...
	<form class="form" action="../board/modifyProcess" method="POST">
		<table class="board">
			...
			<tbody>
				...
				<tr>
					<th>내용</th>
					<td><textarea name="contents" id="summernote">${boardDto.contents }</textarea></td>
				</tr>
			</tbody>
		</table>
...
<script>
	...
	function uploadImage(file, editor) {
		...
		$.ajax({
			...
			type : "POST",
			data : sendData,
			contentType: false, //디폴트 true => enctype="x-www-form-urlencoded" false => multipart/form-data
			processData: false, // QueryString으로 날아가는 걸 막겠다.
